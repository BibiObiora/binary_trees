 ...
 * @parent: A Pointer to heap's node
 */
 ...
 * @root: A Pointer to heap's node
 * @index: The Index of the current node
 * @pind: The Index been searched
 *
 * Return: A Pointer to heap's node
 */
 ...
 * @root: A Doublepointer to heap's root node
 * @parent: A Pointer to parent node from which to remove the last node
 */
 ...
 * @root: A Double pointer to heap's root node
 *
